                        ...
                        <div class="col-xs-6">
                            <form action="profile.php" method="POST" enctype="multipart/form-data">
                                <div class="col-lg-6">
                                    ...
                                    <div class="form-group input-group">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text"> <strong>Edit Specialities</strong> </span>
                                        </div>
                                        <input name="speciality" class="form-control" value="<?php echo $row["speciality"] ?>" placeholder="Write specialities seperated by commas" type="text">
                                    </div>
                                    <br>
                                    <div class="form-group input-group">
                                        <div class="input-group-prepend">
                                    ...
                                    <div class="form-group input-group">
                                        ...
                                        <input name="phone" class="form-control" value="<?php echo $row['phone'] ?>" placeholder="Edit Email" type="text">
                                    </div>
                                    <br>
                                    <div class="form-group input-group">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text"> <strong>Edit Work Area</strong> </span>
                                        </div>
                                        <input name="area" class="form-control" value="<?php echo $row['area'] ?>" type="text">
                                    </div>
                                    <br>
                                    <div class="form-group input-group">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text"> <strong>Edit Work City</strong> </span>
                                        </div>
                                        <input name="city" class="form-control" value="<?php echo $row['city'] ?>" type="text">
                                    </div>
                                    <br>
                                    <div class="form-group input-group">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text"> <strong>Edit Work State</strong> </span>
                                        </div>
                                        <input name="state" class="form-control" value="<?php echo $row['state'] ?>" type="text">
                                    </div>
                                    <br>

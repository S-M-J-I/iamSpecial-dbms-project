                    ...
                    if ($validated) {
                        ...
                        if ($conn_integration->query($sql) === TRUE) { ?>
                            ...
                            <table border="1" class="table table-striped">
                                ...
                                <tr>
                                    <td class="text-right">Donated to</td>
                                    <td>
                                        <?php

                                        $fund_id = $row['fundraiser_id'];
                                        $sql = "SELECT title FROM fundraisers WHERE id='$fund_id'";
                                        $res = mysqli_query($conn_integration, $sql) or die("Failed");

                                        if ($res) {
                                            echo mysqli_fetch_assoc($res)["title"];
                                        }
                                ...
                                <tr>
                                    ...
                                    <td><?= number_format($_POST['amount']) . ' ' . $_POST['currency'] ?></td>
                                </tr>
                            </table>
